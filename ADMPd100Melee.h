...
//          o->type(2);
        ...
        { Fl_Button* o = d1_CombatSpecAttk[scrn] = new Fl_Button(690, 285, 50, 25, "Sp.Attk");
          o->color((Fl_Color)3);
          o->labelsize(ADMP_LABEL_SIZE);
			 o->deactivate();
        }
...
if (scrn == 4) {
	d1_CombatAttkRoll[scrn]->label("Roll");
...
//          o->type(2);
        ...
        { Fl_Check_Browser* o = d1_CombatModifiers[scrn] = new Fl_Check_Browser(755, 365, 165, 175, "Modifiers");
          o->type(3);
          o->color((Fl_Color)2);
          o->labelsize(ADMP_LABEL_SIZE);
          o->textsize(ADMP_TEXT_SIZE);
        ...
        { Fl_Input* o = d1_CombatMods[scrn][0] = new Fl_Input(700, 428, 35, 25, "Mods: OB");
          o->type(2);
          o->color((Fl_Color)3);
          o->labelsize(ADMP_LABEL_SIZE);
          o->textsize(ADMP_TEXT_SIZE);
        }
        { Fl_Input* o = d1_CombatMods[scrn][1] = new Fl_Input(700, 454, 35, 25, "DB");
          o->type(2);
          o->color((Fl_Color)3);
          o->labelsize(ADMP_LABEL_SIZE);
          o->textsize(ADMP_TEXT_SIZE);
        }
        { Fl_Input* o = d1_CombatMods[scrn][2] = new Fl_Input(700, 480, 35, 25, "Damage");
          o->type(2);
          o->color((Fl_Color)3);
          o->labelsize(ADMP_LABEL_SIZE);
          o->textsize(ADMP_TEXT_SIZE);
        }
        { Fl_Input* o = d1_CombatMods[scrn][3] = new Fl_Input(700, 506, 35, 25, "APen");
          o->type(2);
          o->color((Fl_Color)3);
          o->labelsize(ADMP_LABEL_SIZE);
          o->textsize(ADMP_TEXT_SIZE);
