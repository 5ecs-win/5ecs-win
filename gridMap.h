...
public:
	...
	void setGridType(int t) { gridType = t; mapTile->setGridType(t); } // if (t == 1) { vbar->hide(); hbar->hide(); } }
//	void setGridType(int t) { mapTile->setGridType(t); if (t == 1) { vbar->deactivate(); hbar->deactivate(); } }
	...
	void setInactiveIcon(int p, Fl_Image *i) { mapTile->setInactiveIcon(p, i); if (externalGrid != NULL) { externalGrid->setInactiveIcon(p, i); externalGrid->redraw(); } }
